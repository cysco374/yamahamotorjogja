...
<div class="ml2-sidebar">
	...
	<div class="ml2-preview">
		<a href="https://simulator.mobiloud.com/?name=<?php echo rawurlencode( esc_attr( $user_name ) ); ?>&email=<?php echo rawurlencode( esc_attr( $user_email ) ); ?>&site=<?php echo rawurlencode( esc_url( $user_site ) ); ?>&p=<?php echo rawurlencode( esc_url( $plugin_url ) ); ?>&v=<?php echo rawurlencode( esc_attr( $plugin_version ) ); ?>"
	...
	<div class="ml2-side-block">
		...
		<div class="ml2-side-body">
			...
			<?php if ( Mobiloud_Intercom::init_intercom() ) : ?>
				<p><a href="#" onclick="Intercom('showNewMessage', 'Need some help with the MobiLoud News plugin');">Message Us Now</a></p>
			<?php endif; ?>
