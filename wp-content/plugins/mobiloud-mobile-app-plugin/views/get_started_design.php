...
<div class="ml2-block">
	...
	<div class="ml2-body">
		...
		<div class='ml-form-row app-v1-only-feature'>
		...
		<div class="ml-form-row">
			...
			<p>Determines how your articles will be presented in the app, this will be applied to the main list, categories, favorites and search results.</p>
