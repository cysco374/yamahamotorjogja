...
?>
<div class="ml2-block">
	<div class="ml2-header"><h2><?php echo esc_html( Mobiloud_Admin::$settings_tabs[ $active_tab ]['title'] ); // $active_tab defined at MobiloudAdmin. ?></h2></div>
	<div class="ml2-body">
...
<div class="ml2-block">
	...
	<div class="ml2-body">
		...
		<h4 class="app-v2-only-feature">Article list type</h4>
		<p class="app-v2-only-feature">Choose whether to use a Native list or the HTML list to display articles. This applies to all article lists in the app (homescreen AND list tabs)</p>
...
<div class="ml2-block">
	...
	<div class="ml2-body">
		...
		<h4 class="app-v1-only-feature">Internal plugin caching</h4>
		<div class='ml-col-row app-v1-only-feature'>
			<div class='ml-col-half'>
			...
			<div class='ml-col-half'>
				...
				<div class="ml-form-row ml-cache-items"
					...
					<img class="ml-spinner" id="ml_flush_cache_spinner" src="<?php echo esc_attr( MOBILOUD_PLUGIN_URL . 'assets/img/spinner.gif' ); ?>">
				</div>
			</div>
		</div>
