<div class="ml2-block">
	<div class="ml2-header"><h2><?php echo Mobiloud_Admin::$settings_tabs[ $active_tab ]['title']; // $active_tab defined at MobiloudAdmin. phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped ?></h2></div>
	<div class="ml2-body">
		<?php
...
<?php
if ( 'web' === Mobiloud::get_option( 'ml_list_type' ) ) {
	?>
	<!-- new block -->
	<div class="ml2-block" id="ml-login-settings">
		<div class="ml2-header"><h2>Show ads between the articles in the lists</h2></div>
		<div class="ml2-body">
