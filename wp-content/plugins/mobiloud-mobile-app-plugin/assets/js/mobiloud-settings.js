jQuery( document ).ready(
	function() {
		...
		jQuery( "input[name='ml_list_type']" ).on(
			'change',
			function() {
				if ( 'web' === jQuery( "input[name='ml_list_type']:checked" ).val() ) {
					jQuery( '.ml-list-type-native-only' ).hide();
					jQuery( '.ml-list-type-web-only' ).show();
				} else {
					jQuery( '.ml-list-type-native-only' ).show();
					jQuery( '.ml-list-type-web-only' ).hide();
				}
			}
		).trigger( 'change' );
	}
