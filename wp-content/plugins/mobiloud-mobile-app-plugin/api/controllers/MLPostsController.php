...
class MLPostsController {
	...
	public function add_comments( $post_id, $final_post ) {
		static $is_list_type_web = null;
		if ( is_null( $is_list_type_web ) ) {
			$is_list_type_web = 'web' === Mobiloud::get_option( 'ml_list_type', 'native' );
		}
		...
		if ( $is_list_type_web ) { // translated comments number string for web view.
