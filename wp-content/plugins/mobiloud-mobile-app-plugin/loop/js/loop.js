...
function createItemContent( article ) {
	...
	if ( 'undefined' === typeof( article['raw_html'] ) ) {
		...
		// Article element.
		var listItem = ons.createElement( '<ons-list-item class="' + list_item_classes.join( ' ' ) + '" tappable data-ml-post-id="' + article.post_id + '" data-ml-post-permalink="' + article.permalink + '" data-ml-opening-method="' + article.opening_method + '"></ons-list-item>' );
